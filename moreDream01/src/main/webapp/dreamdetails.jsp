			...
			<div class="row">
																				...
																				<c:choose>
																					<c:when
																						...
																						<img class="media-object"
																							src="./upload/member/member_df.jpg" alt=""
																							width="80" height="80">
																					</c:when>
																					<c:otherwise>
																						<img class="media-object"
																							src="./upload/member/${reply.memberVO.member_newFilename}"
				...
				<div class="col-md-3 col-sm-5">
					<div class="sidebar blog-sidebar">
						...
						<p align="center">
							<a
								href="dream.do?command=getRewardByDreamId&&dreamId=${dreamVO.dreamId}"><button
				...
				<div class="media">
					<div class="pull-left">
						<h3 class="page-header">
							<a
								href="dream.do?command=getRewardByDreamId&&dreamId=${dreamVO.dreamId}"><strong>${rl.rewardGuide}</strong><span>원
