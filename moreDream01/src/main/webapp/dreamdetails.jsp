...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                    	<li><a href="finddream.html ">꿈 찾기</a></li>
						<li><a href="createdream.html ">꿈 꾸기</a></li>
                    	<li><a href="# ">도움말</a></li>  
                        <li><a href="# ">로그인</a></li>      
                ...
                <div class="search">
                    <form role="form">
                        ...
                        <div class="field-toggle">
                            <input type="text" class="search-form" autocomplete="off" placeholder="	꿈 검색하기">
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="col-md-9 col-sm-7">
                   ...
                   <div class="col-md-12">
                        <ul id="tab1" class="nav nav-tabs">
                            <li class="active"><a href="#tab1-item1" data-toggle="tab">업데이트</a></li>
    ...
    <div class="col-sm-12 col-md-12">
                            <div class="single-blog single-column">
                                <div class="post-thumb">
                                    <a href="3"><img src="images/blog/9.jpg" class="img-responsive" alt=""></a>
                                    <div class="post-overlay">
                                       <span class="uppercase"><a href="#">14 <br><small>Feb</small></a></span>
                                   </div>
                                </div>
                    ...
                    <div class="sidebar blog-sidebar">
                        <div class="sidebar-item  recent">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4><a href="#">현재 금액 1,000,000</a></h4>
                                    <h4>함께하는 Dreamer 12명</h4>
                                    <h4><a href="#">남은 시간 22일</a></h4>
                                </div>
                            </div>
                        </div>
                       <p align="center">
                       ...
                       <hr>
                       <p><font size="2">결제는 2016년 6월 29일 자정까지 
                       최소 3,000,000원이 모여야만 다함께 진행됩니다	</font></p>
