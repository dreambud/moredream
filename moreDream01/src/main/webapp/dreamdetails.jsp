							...
							<div class="single-blog blog-details two-column">
								...
								<div class="post-content overflow">
									<h2 class="post-title bold">
										<a href="#">Advanced business cards design</a>
									</h2>
									...
									<p>
										...
										humour, or non-characteristic words etc It is a long
											...
											<div class="tab-pane fade active in" id="tab1-item1">
												<div class="col-sm-12 col-md-12">
													<div class="single-blog single-column">
														<div class="post-thumb">
															<a href="3"><img src="images/blog/9.jpg"
																class="img-responsive" alt=""></a>
															<div class="post-overlay">
																<span class="uppercase"><a href="#">14 <br>
																	<small>Feb</small></a></span>
														...
														<div class="post-content overflow">
															<h2 class="post-title bold">
																<a href="blogdetails.html">Advanced business cards
																	design</a>
															</h2>
															<h3 class="post-author">
																<a href="#">Posted by micron News</a>
												...
												<div class="response-area">
													<ul class="media-list">
															...
															<div class="post-comment">
																...
																<div class="media-body">
																	...
																	<p>Lorem ipsum dolor sit amet, consectetur
																		...
																		labore et dolore magna aliq Ut enim ad minim veniam,
																...
																<ul class="media-list">
																	<li class="post-comment reply"><a
																		class="pull-left" href="#"> <img
																			class="media-object" src="images/blogdetails/3.png"
																			alt="">
																	</a>
																		<div class="media-body">
																			<span><i class="fa fa-user"></i>Posted by <a
														...
														<li class="media">
															<div class="post-comment">
																<a class="pull-left" href="#"> <img
																	class="media-object" src="images/blogdetails/4.png"
																	alt="">
																</a>
																<div class="media-body">
																	<span><i class="fa fa-user"></i>Posted by <a
