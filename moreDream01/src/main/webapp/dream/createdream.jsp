...
<body onload="loginCheck()">
					...
					<div class="row">
						<div class="col-md-12">
							...
							카테고리 선택 <select class="form-control" name="category">
								<option value="">프로젝트 카테고리를 선택해주세요</option>
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<!-- 에디터 컨테이너 끝 -->
							...
							&nbsp;
							<div class="input-group" id="fundbox">
								<input type="text" class="form-control"
									aria-label="Amount (to the nearest dollar)" name="targetFund" placeholder="목표금액을 적어주세요" onkeydown="number_chk(event);" style='IME-MODE: disabled' maxlength="8" max="999999999" oninput="maxLengthCheck(this)"
								name="cma_test" id="cma_test" onkeyup="cmaComma(this);" onchange="cmaComma(this);" >
							...
							&nbsp;
							<div align="right">
								<button type="button" class="btn btn-lg btn-default" onclick="inputDetail();">
